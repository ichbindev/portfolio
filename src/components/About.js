...
const About = props => {
  return (
    ...
    >
      ...
      <p>
        Several years later I graduated with a Bachelor’s in Computer Science
        from the University of Texas at Austin. In school, although my coding
        pursuits were mostly academic, I found the most enjoyment in building
      ...
      <p>
        ...
        Vrbo), an online vacation rental marketplace. My focus drifted more and
        more towards the backend (Java) where I built high-throughput APIs and
        owned an auto-translation service that was responsible for all machine
        translated text on the site. I also led DevJr, a group to help junior
        developers learn and grow, by finding monthly speakers to talk about a
        wide range of topics focusing on tech and career.
      </p>
      <p>
        Unfortunately, I ended up with a foot injury that was diagnosed
        incorrectly. It continued to worsen until I had to to take a leave from
        work and focus on my health. My issue was diagnosed and two surgeries
        and some physical therapy later and I was ready to start coding again.
        As I was recovering from surgery, I decided to take a full-stack coding
        bootcamp to get back into a routine and coding every day. This gave me
        some structured learning and experience with the latest technologies.
      </p>
      <p>
